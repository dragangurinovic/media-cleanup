        ...
        wp_localize_script(
            ...
            array(
                ...
                'i18n'    => array(
                    ...
                    'scanningDuplicates'  => __( 'Scanning for duplicate files...', 'media-cleanup' ),
                    'noDuplicates'        => __( 'No duplicate files found.', 'media-cleanup' ),
                    'scanningBrokenLinks' => __( 'Scanning for broken media links...', 'media-cleanup' ),
                    'noBrokenLinks'       => __( 'No broken media links found.', 'media-cleanup' ),
                    'confirmQuarantine'   => __( 'Move %d item(s) (%s) to quarantine? Files can be restored later.', 'media-cleanup' ),
                    'quarantineComplete'  => __( 'Quarantine complete.', 'media-cleanup' ),
                    'restoring'           => __( 'Restoring...', 'media-cleanup' ),
                    'restoreComplete'     => __( 'Restore complete.', 'media-cleanup' ),
                    'noQuarantineItems'   => __( 'No items in quarantine.', 'media-cleanup' ),
                    'scanningOptimizable' => __( 'Scanning for optimizable images...', 'media-cleanup' ),
                    'noOptimizable'       => __( 'No images need optimization.', 'media-cleanup' ),
                    'optimizing'          => __( 'Optimizing...', 'media-cleanup' ),
                    'optimizeComplete'    => __( 'Optimization complete.', 'media-cleanup' ),
                    'confirmOptimize'     => __( 'Optimize %d image(s)? Original files will be replaced.', 'media-cleanup' ),
                    'scheduleSaved'       => __( 'Schedule settings saved.', 'media-cleanup' ),
                ),
            )
        );
    }
